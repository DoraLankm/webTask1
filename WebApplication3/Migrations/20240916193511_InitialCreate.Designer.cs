...
namespace WebApplication3.Migrations
{
    ...
    [Migration("20240916193511_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication3.Models.ProductStorage", b =>
                {
            ...
            modelBuilder.Entity("WebApplication3.Models.ProductStorage", b =>
                {
                    ...
                    b.HasOne("WebApplication3.Models.Storage", "Storage")
                        .WithMany("ProductStorage")
            ...
            modelBuilder.Entity("WebApplication3.Models.Storage", b =>
                {
                    b.HasOne("WebApplication3.Models.Product", "Product")
                        .WithOne()
                        .HasForeignKey("WebApplication3.Models.Storage", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
